...
<section class="container">
    <div class="row justify-content-center">
        <div class="col-md-6">
            ...
            <table class="table table-hover table-dark mt-5 text-center">
                <thead>
                    <tr>
                        ...
                        <th>Editar</th> <!-- Agregamos una columna adicional para el botón de eliminar -->
                    </tr>
                </thead>
                <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="../controller/actualizar.php" method="post">
                                    <input type="hidden" name="identificadorActualizar" value="<?= $key['id']; ?>">
                                    <button type="submit" name="actualizar" class="btn btn-success">Editar</button>
                                </form>
                            </td>
                        </tr>
                    <?php } ?>
            ...
            <div>
                <a class="btn btn-warning mt-4" href="guardar.php">Volver</a>
            </div>
        </div>
    </div>
</section>