                    ...
                    <div class="card-body">
                        <form action="../controller/actualizar.php" method="POST">
                            <?php foreach ($actualizar as $key) { 
                                ...
                                <div class="mt-4 mb-4">
                                    <input type="submit" name="envio_edit" class="btn btn-success w-100" value="Editar">
                                </div>
                            <?php } ?>
                        </form>
                        <div class="text-center mt-2">
                            <a href="../vistas/listarEliminar.php" class="btn btn-dark text-white w-100">Volver</a>
                        </div>
                    </div>
                </div>
            </div>
